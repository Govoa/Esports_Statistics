!function (e, t) {
    ...
    return function (e) {
        ...
        function (e, t, r) {
            ...
            function s(e) {
                ...
                return Object
                    ...
                    .forEach(function (r) {
                        ({})
                            .hasOwnProperty
                            .call(c.legacyOptions, r)
                                ? t[c.legacyOptions[r]] = e[r]
                                : t[r] = e[r]
                    }),
                t
            }
            function i(e) {
                var t = {};
                if (t.target = (0, d.extractElement)(e.target), t.fetchSize = Math.max(
                    0,
                    parseInt(e.fetchSize, 10) || 0
                            ...
                            get: function () {
                                var e = this.options.user.fetchSize,
                                    ...
                                    r = [
                                        ...
                                        "tq=" + encodeURIComponent(this.options.user.query + t)
                                    ];
                    ...
                    return s(e, [
                        {
                                ...
                                this.request.state.offset || (o = r.map(function (e, r) {
                                    return e.label
                                        ? e
                                            .label
                                            .replace(/\s/g, "")
                                        : (n.last += 1, n.rowNumberOffset = 1, d.getCellValue(t[0].c[r]) || e.id)
                                }), this.request.update({
                            ...
                            value: function () {
                                var e = this;
                                this.rows = [],
                                this.request.state.offset || this.attributes.rowNumberOffset || this
                                    .rows
                                    .push(new u.default(0, this.attributes.labels, this.attributes.labels)),
                                this
                                    .raw
                                    .table
                                    .rows
                                    .forEach(function (t, r) {
                                        if (t.c && r < e.attributes.last) {
                                            ...
                                            e
                                                .rows
                                                .push(new u.default(n, t.c, e.attributes.labels))
                                        }
                                    }),
                                this
                                    .request
                            ...
                            value: function () {
                                ...
                                r && (o = d.wrapTag(o, "thead"), a = d.wrapTag(a, "tbody")),
                                d.append(e, o + a),
                                this.html = o + a
                            }
                        }, {
